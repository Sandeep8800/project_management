...
public record BoardColumnResponse(UUID columnId, String name, int displayOrder, Integer wipLimit, List<IssueResponse> issues) {
    public static BoardColumnResponse from(BoardService.BoardColumnView view) {
        return new BoardColumnResponse(view.columnId(), view.name(), view.displayOrder(), view.wipLimit(),
